...
public interface AssemblyDrillLaserRecipeSchema {
    RecipeKey<InputItem> INPUT = ItemComponents.INPUT.key("input");
    RecipeKey<OutputItem> OUTPUT = ItemComponents.OUTPUT.key("result");
    RecipeKey<AssemblyProgramType> PROGRAM = new EnumComponent<>(AssemblyProgramType.class)
            .key("program")
            .optional(AssemblyProgramType.DRILL_LASER).alwaysWrite();
